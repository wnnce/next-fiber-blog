...
func newApp(ctx context.Context, cf *conf.Server, tagApi *tag.HttpApi, catApi *category.HttpApi, conApi *concat.HttpApi,
	...
	userApi *manage.UserApi, dictApi *manage.DictApi) *fiber.App {
	...
	api.RegisterRoutes(app, tagApi, catApi, conApi, linkApi, menuApi, cfgApi, oApi, roleApi, userApi, dictApi)
	return app
}
